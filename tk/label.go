...
// tk.NewLabel(parent Widget, text string) ==> ttk.Label
// tk.NewLabel(parent Widget, text string, useTkWidget) ==> use tk.Label

// w.ConfigSet(key string, value string) error
// w.ConfigGet(key string) string
// ttk key : 
// tk key : "activebackground","activeforeground","anchor","background",
//			"borderwidth","compound","cursor","disabledforeground","font",
