...
// tk.NewLabelFrame(parent Widget) ==> ttk.LabelFrame
// tk.NewLabelFrame(parent Widget, useTkWidget) ==> tk.LabelFrame

// w.ConfigSet(key string, value string) error
// w.ConfigGet(key string) string
// ttk key : 
// tk key : text, labelanchor[nw,n,ne,en,e,es,se,s,sw,ws,w and wn.default nw]
